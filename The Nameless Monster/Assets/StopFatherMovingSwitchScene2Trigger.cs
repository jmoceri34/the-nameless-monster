...
public class StopFatherMovingSwitchScene2Trigger : MonoBehaviour
{
    ...
    void OnTriggerEnter2D(Collider2D collider)
    {
        if (collider.transform.parent.parent.name == "Father")
        {
            ...
            ListenerService.Invoke(GameEventType.SwitchCameraScene2);
            var pos = GameObject.FindGameObjectWithTag("Player").transform.position;
            GameObject.FindGameObjectWithTag("Player").transform.localPosition = new Vector3(14f, pos.y, pos.z);
